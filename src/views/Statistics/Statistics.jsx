...
export const Statistics = () => {
  const [activeView, setActiveView] = useState('stats'); // 'stats' o 'journal'
    ...
    const mockEntries = [
      {
        ...
        activity_description: 'Practiced conversation with a language partner for 30 minutes. Discussed daily routines and weekend plans.',
        emotion: 'happy',
        emotional_experience: 'Felt confident and enjoyed the natural flow of conversation.',
        difficulty: 'easy',
        challenges: 'Had some trouble with past tense verbs, but overall it went smoothly.',
        differences: 'Would prepare more vocabulary related to specific topics beforehand.',
      ...
      },
      {
        ...
        activity_description: 'Read a short article about climate change and completed grammar exercises on conditionals.',
        emotion: 'proud',
        emotional_experience: 'Proud of understanding complex sentences without translating.',
      ...
      },
      {
        ...
        emotion: 'neutral',
        emotional_experience: 'It was okay, not particularly exciting but productive.',
        difficulty: 'neutral',
      ...
      },
      {
        ...
        activity_description: 'Listened to a podcast and read the transcript afterwards.',
        emotion: 'tired',
  ...
  const getStatistics = () => {
    if (entries.length === 0) return { activities: [], emotions: [], difficulties: [] };
    ...
    const activitiesData = Object.entries(activityCounts).map(([name, count]) => ({
      name,
      count
    }));
    ...
    const difficultiesData = Object.entries(difficultyCounts).map(([name, count]) => ({
    ...
    return (
      <div className="min-h-screen bg-gray-50 flex items-center justify-center">
        <div className="text-center">
          ...
          <p className="text-gray-600 text-lg">No entries yet. Start your learning journey!</p>
        </div>
      </div>
    );
  }
        ...
        {activeView === 'stats' && (
          <div className="space-y-8">
            ...
            <div className="bg-white rounded-lg shadow-md p-6">
              <h2 className="text-2xl font-bold text-gray-800 mb-4">Your Learning Summary</h2>
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                ...
                <div className="text-center p-4 bg-purple-50 rounded-lg">
                  <p className="text-3xl font-bold text-purple-600">
                    {Math.ceil((new Date(entries[0].entry_date) - new Date(entries[entries.length - 1].entry_date)) / (1000 * 60 * 60 * 24))}
                  </p>
            ...
            <div className="bg-white rounded-lg shadow-md p-6">
              <h3 className="text-xl font-bold text-gray-800 mb-4">Activities Distribution</h3>
            ...
            <div className="bg-white rounded-lg shadow-md p-6">
              <h3 className="text-xl font-bold text-gray-800 mb-4">Emotional Experience</h3>
              <ResponsiveContainer width="100%" height={300}>
            ...
            <div className="bg-white rounded-lg shadow-md p-6">
              <h3 className="text-xl font-bold text-gray-800 mb-4">Difficulty Levels</h3>
              <ResponsiveContainer width="100%" height={300}>
          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="bg-white rounded-lg shadow-xl p-8 md:p-12 relative">
              ...
              <div className="border-b-2 border-gray-200 pb-4 mb-6">
                <h2 className="text-3xl font-bold text-gray-800">{formatDate(currentEntry.entry_date)}</h2>
                <p className="text-sm text-gray-500 mt-1">Entry {currentEntryIndex + 1} of {entries.length}</p>
              </div>
              ...
              <div className="mb-6">
                ...
                <p className="text-gray-600 leading-relaxed">{currentEntry.activity_description}</p>
              </div>
              ...
              <div className="mb-6">
                ...
                <div className="flex items-center gap-2 mb-2">
                  <span className="text-2xl">{getEmotionEmoji(currentEntry.emotion)}</span>
                  <span className="text-gray-600 capitalize">{currentEntry.emotion}</span>
                </div>
                <p className="text-gray-600 leading-relaxed">{currentEntry.emotional_experience}</p>
              </div>

              {/* Dificultad y desafíos */}
              <div className="mb-6">
                <h3 className="font-bold text-gray-700 mb-2">Challenges</h3>
                <p className="text-sm text-gray-500 mb-1">Difficulty: <span className="capitalize font-medium">{currentEntry.difficulty}</span></p>
                <p className="text-gray-600 leading-relaxed">{currentEntry.challenges}</p>
              </div>

              {/* Reflexiones */}
              <div className="mb-6">
                <h3 className="font-bold text-gray-700 mb-2">Next Time I Would...</h3>
                <p className="text-gray-600 leading-relaxed">{currentEntry.differences}</p>
              </div>
              ...
              <div className="flex justify-between items-center mt-8 pt-6 border-t-2 border-gray-200">
                ...
                <div className="text-center">
                  <p className="text-sm text-gray-500">
                    {new Date(currentEntry.entry_date).toLocaleDateString('en-US', { month: 'short', day: 'numeric', year: 'numeric' })}
                  </p>
                </div>
